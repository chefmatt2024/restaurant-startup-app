...
const UserManagement = () => {
  ...
  const getStats = () => {
    ...
    const revenue = users.reduce((sum, u) => sum + u.totalValue, 0);

    return { total, trials, paid, expired, revenue };
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage users, track progress, and monitor engagement</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{stats.trials}</p>
            </div>
          </div>
        </div>
