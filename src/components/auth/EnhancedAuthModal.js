...
const EnhancedAuthModal = ({ isOpen, onClose, initialMode = 'login', initialEmail = '' }) => {
    ...
    try {
      if (mode === 'login') {
        ...
        if (formData.rememberMe) {
          localStorage.setItem('lastUserEmail', formData.email);
        }
        ...
        <div className="relative bg-gradient-to-r from-blue-600 to-purple-600 p-6 rounded-t-xl">
          ...
          <div className="text-center">
            ...
            <p className="text-blue-100 mt-2 text-sm">
              {mode === 'login' && 'Sign in to continue planning your restaurant'}
              {mode === 'register' && 'Start your restaurant planning journey today'}
              {mode === 'forgot-password' && 'We\'ll send you a password reset link'}
            </p>
          </div>
        </div>
        ...
        {mode === 'register' && (
          <div className="px-6 pt-4 pb-2">
            <div className="flex items-center justify-center space-x-1 text-sm text-gray-600">
              ...
              <span className="ml-2">Trusted by 500+ restaurant entrepreneurs</span>
            </div>
          </div>
        )}
