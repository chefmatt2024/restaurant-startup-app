...
export const AI_STEP_PLACEHOLDERS = {
  ...
  'vendors-expenses': "Ask about vendors or expenses: 'What vendors do I need?', 'How do I track expenses vs invoices?', 'What categories for expenses?', 'When to mark an invoice paid?'",
